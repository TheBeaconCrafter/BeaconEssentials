        ...
        if (player.hasPermission("beacon.beaconessentials.msg.write")) {
            if(args.length >= 2){
                ...
                if(target != null){
                    ...
                    player.sendMessage(Beaconessentials.PREFIX + "§8[§7Du §a-> §e" + target.getName() + "§8] §f" + stringBuilder.toString());
                    target.sendMessage(Beaconessentials.PREFIX + "§8[§e" + player.getName() + " §a-> §7Dich§8] §f" + stringBuilder.toString());
